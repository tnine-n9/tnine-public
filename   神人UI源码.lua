...
function library.new(library, name, theme)
  ...
  Open.MouseButton1Click:Connect(function()
    Main.Visible = not Main.Visible
    Open.Image = Main.Visible and "rbxassetid://127847250671785" or "rbxassetid://91545768718105" --开关的图
  end)
  ...
  function window.Tab(window, name, icon)
    ...
    TabIco.Image = "rbxassetid://128437395815901" or icon and "rbxassetid://" .. icon
        ...
        local funcs = {
          SetState = function(self, state)
            ...
            services.TweenService:Create(ToggleSwitch, TweenInfo.new(0.2), {
              ...
              BackgroundColor3 = (state and Color3.fromRGB(139, 0, 255) or beijingColor)
            }):Play()
